...
export const MEATS: Ingredient[] = [
  { id: "beef",    name: "소고기", emoji: "🥩", image: "/img/meet.png",    type: "meat",   position: { top: "30%", left: "28%", width: "90px" } },
  { id: "spam",    name: "스팸",   emoji: "🥫", image: "/img/spam.png",    type: "meat",   position: { top: "30%", left: "61%", width: "80px" } },
  { id: "sausage", name: "소세지", emoji: "🌭", image: "/img/sausage.png", type: "meat",   position: { top: "28%", left: "51%", width: "84px" } },
];

export const VEGGIES: Ingredient[] = [
  { id: "bokchoy", name: "청경채", emoji: "🥬", image: "/img/vege.png",    type: "veggie", position: { top: "28%", left: "22%", width: "76px" } },
  { id: "sprouts", name: "숙주",   emoji: "🌱", image: "/img/sprouts.png", type: "veggie", position: { top: "23%", left: "38%", width: "110px" } },
  { id: "cabbage", name: "배추",   emoji: "🥗", image: "/img/cabbage.png", type: "veggie", position: { top: "27%", left: "65%", width: "73px" } },
];

export const NOODLES: Ingredient[] = [
  { id: "bunmoja",  name: "분모자",   emoji: "🍢", image: "/img/bunmoja.png", type: "noodle", position: { top: "36%", left: "50%", width: "74px" } },
  { id: "dangmyun", name: "중국당면", emoji: "🍜", image: "/img/china.png",   type: "noodle", position: { top: "34%", left: "32%", width: "77px" } },
  { id: "corn",     name: "옥수수면", emoji: "🌽", image: "/img/cone.png",    type: "noodle", position: { top: "28%", left: "40%", width: "105px" } },
];

export const OTHERS: Ingredient[] = [
  { id: "sweetrice",   name: "고구마떡", emoji: "🍡", image: "/img/tteok.png", type: "other", position: { top: "19%", left: "30%", width: "75px" } },
  { id: "cheesetteok", name: "연근",   emoji: "", image: "/img/lotusroot.png",   type: "other", position: { top: "30%", left: "44%", width: "80px" } },
